...
class Note:
    def __init__(self, obj: TiledObject):
        ...
        text = font.render(obj.properties["text"], False, "black")
        text_rect = text.get_rect(center=(self.rect.centerx, self.rect.y - text.get_height()))
        self.text_pos = pygame.Vector2(text_rect.topleft)

        self.text_fade = FadingImage(text, 150, 0)
